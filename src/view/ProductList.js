...
class ProductList extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.productList.categoryList && this.props.productList.categoryList.length === 0) {
            //TODO 从后台获取数据
            //本地测试静态数据
            this.props.dispatch({
                type: 'productList',
    ...
    handleSelectCategory(categoryId, categoryItem) {
        let selectCategory = this.props.productList.selectCategory;
        ...
        let categoryList = this.props.productList.categoryList;
    ...
    handleCancelSelect(categoryId, categoryItemId) {
        let selectCategory = this.props.productList.selectCategory;  //获取数组元素
            ...
            <div>
                ...
                <div className="all_classify container col-no-padding">
                    ...
                    <div className="col-md-11 col-xs-10">
                        <div className="col-md-9 col-no-padding">
                            <ul className="list-inline all_item">
                                {
                                    this.props.productList.selectCategory.map((categoryItem, index) =>
                    ...
                    <div className="category_list margin-top">
                        <ul>
                            {
                                this.props.productList.categoryList.map((category, index) =>
                    ...
                    <div className="pro_item container col-no-padding min_width">
                        <ul className="margin-top-100">
                            {
                                this.props.productList.goodsList.map((goodsList, index) =>
