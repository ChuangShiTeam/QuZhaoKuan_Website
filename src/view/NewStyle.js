...
class NewStyle extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.newStyle.categoryList && this.props.newStyle.categoryList.length === 0) {
            //TODO 从后台获取数据
            //本地测试静态数据
            this.props.dispatch({
                type: 'newStyle',
            ...
            <div>
                ...
                <div className="all_classify container col-no-padding">
                    ...
                    <div className="category_list margin-top">
                        <ul>
                            {
                                this.props.newStyle.categoryList.map((category, index) =>
